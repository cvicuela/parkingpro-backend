...
('ncf_series_consumer', 'B01', 'Serie NCF para facturas de consumidor final (provisional)', 'facturacion'),
('ncf_series_fiscal', 'B14', 'Serie NCF para facturas con valor fiscal (provisional)', 'facturacion'),
('ncf_series_credit', 'B04', 'Serie NCF para notas de crédito (provisional)', 'facturacion'),
